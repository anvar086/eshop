                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{asset('assets/images/products/social_list.png')}}" alt=""></a>
                        </div>
                        @if($product->sale_price > 0&& $sale->status==1 && $sale->date > Carbon\Carbon::now())
                        ...
                        <div class="wrap-butons">
                            @if($product->sale_price > 0&& $sale->status==1 && $sale->sale > Carbon\Carbon::now())
